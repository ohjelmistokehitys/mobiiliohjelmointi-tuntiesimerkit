// example repository by GitHub and borrowed from documentation:
...
// typescript infers the type of the object, and we give that type a name
export type GitHubRepo = typeof example;